...
from sqlalchemy import String, DateTime, Integer, Text, JSON, select, delete, desc, and_
...
class PostgresLogger:
    ...
    async def get_conversation_by_id(self, conversation_id: str) -> Optional[ConversationResult]:
